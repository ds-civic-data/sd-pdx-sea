...
```{r 1.0, echo=FALSE, warning = FALSE, message=FALSE}
setwd("~/sd-pdx-sea/White_paper_docs")
source("Refined_Sankey.R")
```
```{r 1.1, warning = FALSE, out.width="120%"}
 setwd("~/sd-pdx-sea/White_paper_docs")
...
```{r 2.1 s/b plots, warning = FALSE, message=FALSE}
pdx_sector
sf_sector
sea_sector
```
...
```{r 4, warning = FALSE, echo = FALSE, message=FALSE}
 setwd("~/sd-pdx-sea/White_paper_docs")
source("Modelling.R")
```

```{r 4.1, warning = FALSE, message=FALSE}
mod0_sum
mod1_sum
...
```{r 4.2, warning = FALSE, message=FALSE}
hmod0_sum
hmod1_sum
...
```{r 4.3, warning = FALSE, message=FALSE}
hmod3_sum
hmod4_sum
```
...
```{r 4.4, warning = FALSE, message=FALSE}
hmod5_sum
hmod6_sum
```
