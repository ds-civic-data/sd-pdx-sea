...
```
```{r}
outflow <- left_join(outflow_1516_agg, outflow_1314_agg, by = c("origin_area" = "origin_area", "dest_area" = "dest_area"))
...
names(outflow) <- c("origin_area", "dest_area", "1516", "1314", "1213", "1112", "1011", "0910", "0809")
```
```{r}
