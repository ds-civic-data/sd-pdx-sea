...
migration2<- rbind(as.data.frame(outflow2), as.data.frame(migration))
...
links = as.data.frame(matrix(c(
 0, 5, 1, # Each row represents a link. The first number
 0, 6, 2, # represents the node being conntected from. 
 0, 7, 3, # the second number represents the node connected to.
 0, 8, 4,
 1, 5, 3,
 1, 6, 2,
 1, 7, 1,
